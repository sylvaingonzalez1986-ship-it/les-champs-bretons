  ...
  if (emailSent) {
    return (
      ...
      >
        ...
        <Text style={{ color: COLORS.text.muted }} className="text-center mb-4 px-4">
        ...
        >
          <Text style={{ color: COLORS.primary.paleGold }} className="text-sm text-center">
            Important : Ouvrez le lien depuis votre téléphone pour qu'il s'ouvre dans l'application.
          </Text>
        </View>
        <Pressable
