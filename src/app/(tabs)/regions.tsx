...
import { useProducerStore, useProductReviewsStore, useSupabaseSyncStore } from '@/lib/store';
import { usePermissions } from '@/lib/useAuth';
import { Producer, PRODUCT_TYPE_COLORS, SAMPLE_PRODUCERS } from '@/lib/producers';
...
export default function RegionsScreen() {
  ...
  // Verifier l'acces PRO
  const hasAccess = isPro || isAdmin;

  // Combine producers: admin uses local, non-admin uses Supabase synced
  ...
  // Grouper les producteurs par region
