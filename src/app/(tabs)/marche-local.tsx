...
import { MapPin, Store, ChevronRight, ShoppingCart, ShoppingBag, Check, ChevronDown, ChevronUp, Zap, ClipboardList, Sparkles, X, Star, Leaf, Layers } from 'lucide-react-native';
                  ...
                  {producer.products.slice(0, 3).map((product) => {
                    ...
                    return (
                      ...
                      >
                            ...
                            <View className="flex-row items-center">
                              ...
                              {hasTieredPricing && lowestTierPrice && (
                                <View className="flex-row items-center ml-2">
                                  <Layers size={10} color={COLORS.accent.hemp} />
                                  <Text className="text-xs ml-0.5" style={{ color: COLORS.accent.hemp }}>
                        ...
                        {/* Badge tarif dégressif */}
                        {hasTieredPricing && (
                          <View
                            className="mx-2 mb-2 px-2 py-1 rounded-md flex-row items-center"
                            style={{ backgroundColor: 'rgba(212, 168, 83, 0.12)' }}
                          >
                            <Layers size={12} color={COLORS.primary.paleGold} />
                            <Text className="text-xs ml-1" style={{ color: COLORS.primary.paleGold }}>
                              Tarif dégressif disponible
                            </Text>
                          </View>
                        )}
                      </View>
